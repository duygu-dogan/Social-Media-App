...
import './postingmodule.scss'

const PostingModule = () => {
    return (
        <div className='posting-main content-center flex flex-col'>
            <form className='my-4'>
                <div className='flex mx-10 gap-5 post-main-text pb-8 my-4'>
                    ...
                    <textarea type="text" className='bg-transparent text-xl focus:outline-none align-placeholder' placeholder="What do you think?"
                        rows="1" onInput={(e) => {
